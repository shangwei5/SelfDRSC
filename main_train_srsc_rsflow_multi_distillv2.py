...
def main(json_path='options/train_srsc_rsflow_multi_distillv2_psnr.json'):
        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for test_data in test_loader:
                    idx += 1
                    # print(test_data[5][0])
                    image_name_ext = os.path.basename(test_data[6][0][0])   #test_data[5][0][0]
                    ...
                    for save_idx in range(len(E_img)):
                        save_img_path = os.path.join(img_dir, 'E{:d}_{:d}.png'.format(save_idx,current_step))
