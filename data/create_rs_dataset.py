...
if __name__ == '__main__':
    ...
    for i in range(30, 45):
        if i >= 15 and i <= 19:
            print("Have done!")
            continue
        path = '/mnt/disk10T/shangwei/data/REDS/train/train_orig_rs/{:03d}'.format(i)
        if not os.path.exists(path):
            continue
        VE.imgs2video(path, '/mnt/disk10T/shangwei/data/REDS/train/train_orig_rs/{:03d}.avi'.format(i), 30)
        ...
        VE.gen_rs_video(VE('/mnt/disk10T/shangwei/data/REDS/train/train_orig_rs/{:03d}.avi'.format(i), True),
                        rs_video_path='/mnt/disk10T/shangwei/data/RS-REDS_DS/{:03d}/'.format(i), src_fps=16400,
                        dst_fps=15, row_syn_frames=15, row_gap_frames=2, scan_mode='both')  # 030~059
