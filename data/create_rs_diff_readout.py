...
class VideoEdit:
    ...
    def gen_rs_video(self, rs_video_path, src_fps=15360, dst_fps=24, disp_fps=15, row_syn_frames=10, row_gap_frames=1,
                     gt_frames=9, scan_mode='both', gamma=False): # src_fps 16400  dst_fps 15      syn 15    gap2  #readout 133 us
        # default 100us
        ...
        temp_imgs = [self.img, ]
        count = 0
        num_temp_imgs = int(src_fps / dst_fps)  #512
...
if __name__ == '__main__':
    VE = VideoEdit
    # path = '/mnt/disk10T/shangwei/data/REDS/023_64X'
    # VE.imgs2video(path, '/mnt/disk10T/shangwei/data/REDS/23_diff_readout.avi', 30)
    ## VE.gen_rs_video(VE('/mnt/disk10T/shangwei/data/REDS/train/train_orig_rs/{:03d}.avi'.format(i), True),
    ##                 rs_video_path='/mnt/disk10T/shangwei/data/RS-REDS_DS/{:03d}/'.format(i), src_fps=15360, dst_fps=24,
    ##                 row_syn_frames=10, row_gap_frames=1, scan_mode='both')  #000~029
    VE.gen_rs_video(VE('/mnt/disk10T/shangwei/data/REDS/23_diff_readout.avi', True),
                    rs_video_path='/mnt/disk10T/shangwei/data/REDS/23_195us/', src_fps=153600,
                    dst_fps=40, row_syn_frames=21, row_gap_frames=3, scan_mode='both')  # 15,2, 130  #10,1, 65
